...
const createWindow = async () => {
  ...
  // const rectangle = [
  //   { x: borderWidth, y: 0, width: width - borderWidth * 2, height },
  //   { x: 0, y: borderWidth, width: borderWidth, height: height - borderWidth * 2 },
  //   { x: width - borderWidth, y: borderWidth, width: borderWidth, height: height - borderWidth * 2 },
  //   { x: borderWidth, y: height - borderWidth, width: width - borderWidth * 2, height: borderWidth },
  // ];
